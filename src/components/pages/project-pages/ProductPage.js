...
function ProductPage() {
  ...
  return (
    <div className="project-page__container project-page product__page" >
      <div>
        <img src='images/project-images/PP/PP-00.png' className='lg__image'></img>
      </div>
      ...
      <div id="section2">
        ...
        <img loading="lazy" src='images/project-images/PP/PP-B01.png' className='md__image'></img>
        <img loading="lazy" src='images/project-images/PP/PP-B02.png' className='md__image'></img>
        <img loading="lazy" src='images/project-images/PP/PP-B03.png' className='md__image'></img>
        <img loading="lazy" src='images/project-images/PP/PP-B04.png' className='md__image'></img>
        <img loading="lazy" src='images/project-images/PP/PP-B05.png' className='md__image'></img>
      </div>
      ...
      <div id="section3">
        ...
        <img loading="lazy" src='images/project-images/PP/PP-C01.png' className='lg__image'></img>
        ...
        <img loading="lazy" src='images/project-images/PP/PP-C02.png' className='md__image'></img>
        <h4>Direction 2: Use a large side drawer</h4>
        <img loading="lazy" src='images/project-images/PP/PP-C03.png' className='md__image'></img>
        ...
        <img loading="lazy" src='images/project-images/PP/PP-C04.png' className='md__image'></img>
        ...
        <img loading="lazy" src='images/project-images/PP/PP-C05.png' className='md__image'></img>
        ...
        <img loading="lazy" src='images/project-images/PP/PP-C06.png' className='md__image'></img>
        <img loading="lazy" src='images/project-images/PP/PP-C07.png' className='md__image'></img>
        ...
        <img loading="lazy" src='images/project-images/PP/PP-C08.png' className='md__image'></img>
        ...
        <img loading="lazy" src='images/project-images/PP/PP-C09.png' className='lg__image'></img>
      ...
      <div id="section4">
        ...
        <h4>Research plan</h4>
        <img loading="lazy" src='images/project-images/PP/PP-D00.png' className='md__image__shadow'></img>
        <h4>Testing sessions</h4>
        <img loading="lazy" src='images/project-images/PP/PP-D01.png' className='md__image__shadow'></img>
        ...
        <img loading="lazy" src='images/project-images/PP/PP-D02.png' className='lg__image'></img>
        ...
        <img loading="lazy" src='images/project-images/PP/PP-D03.png' className='lg__image'></img>
        ...
        <img loading="lazy" src='images/project-images/PP/PP-D04.png' className='lg__image'></img>
        ...
        <img loading="lazy" src='images/project-images/PP/PP-D05.png' className='lg__image'></img>
        ...
        <img loading="lazy" src='images/project-images/PP/PP-D06.png' className='lg__image'></img>
        ...
        <img loading="lazy" src='images/project-images/PP/PP-D07.png' className='lg__image'></img>
      </div>
      ...
      <div id="section5">
        ...
        <img loading="lazy" src='images/project-images/PP/PP-E01.png' className='lg__image'></img>
        <h3>Search products by IDs</h3>
        <img loading="lazy" src='images/project-images/PP/PP-E02.png' className='lg__image'></img>
        <h3>Quickly clear search and filters</h3>
        <img loading="lazy" src='images/project-images/PP/PP-E03.png' className='lg__image'></img>
        <h3>Prompt to select enough products</h3>
        <img loading="lazy" src='images/project-images/PP/PP-E04.png' className='lg__image'></img>
        <h3>Responsive drawer design</h3>
        <img loading="lazy" src='images/project-images/PP/PP-E05.png' className='lg__image'></img>
