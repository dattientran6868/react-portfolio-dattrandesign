...
function FirstPartyAudience() {
    ...
    return (
        <div className="project-page__container project-page first__party__audience" >
            ...
            <div id="section2">
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-B1.png' className='sm__image'></img>
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-B2.png' className='md__image'></img>
            </div>
            ...
            <div id="section3">
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-C-Userflow1.png' className='lg__image'></img>
                <h3>Upload</h3>
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-C1.png' className='lg__image'></img>
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-C2.png' className='lg__image'></img>
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-C3.png' className='lg__image'></img>
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-C4.png' className='lg__image'></img>
            </div>
            ...
            <div id="section4">
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-user-testing.png' className='lg__image'></img>
                <p className='space'>A</p>
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-D-Userflow1.png' className='lg__image'></img>
                <p>The upload flow was moved from a drawer interface to a full-page view, allowing users to fully focus on the process.</p>
                <img loading="lazy" src='images/project-images/FPA/FPA-D1.png' className='lg__image'></img>
                <p className='space'>A</p>
                <p>Users could retry upload the rejected audience file in the full page.</p>
                <img loading="lazy" src='images/project-images/FPA/FPA-D2.png' className='lg__image'></img>
                <p className='space'>A</p>
                <p>Users could edit or update the audience file in the full page.</p>
                <img loading="lazy" src='images/project-images/FPA/FPA-D3.png' className='lg__image'></img>
                <p className='space'>A</p>
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-D-Userflow2.png' className='lg__image'></img>
                <p className='space'>A</p>
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-D4.png' className='lg__image'></img>
                <p className='space'>A</p>
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-D5.png' className='lg__image'></img>
            </div>
            ...
            <div id="section5">
                ...
                <img loading="lazy" src='images/project-images/FPA/FPA-E1.png' className='lg__image'></img>

                <h3>5.2 Update (Edit) flow </h3>
                <img loading="lazy" src='images/project-images/FPA/FPA-E5.png' className='lg__image'></img>

                <h3>5.3 Post-Upload and Post-Update flow</h3>
                <h4>Case 1: If the user chose to generate Suggested audiences</h4>
                <img loading="lazy" src='images/project-images/FPA/FPA-E2.png' className='lg__image'></img>
                <h4>Case 2: If the user didn't choose to generate Suggested audiences</h4>
                <img loading="lazy" src='images/project-images/FPA/FPA-E3.png' className='lg__image'></img>
                <h4>Case 3: If LiveRamp rejected the file, the user could retry uploading another file</h4>
                <img loading="lazy" src='images/project-images/FPA/FPA-E4.png' className='lg__image'></img>

                <h3>5.4 Delete flow</h3>
                <img loading="lazy" src='images/project-images/FPA/FPA-E6.png' className='lg__image'></img>
