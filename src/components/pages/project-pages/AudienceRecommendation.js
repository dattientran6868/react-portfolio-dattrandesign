  ...
  return (
    <div className="project__container audience__recommendation" >
      ...
      <div id="section2">
        ...
        <img loading="lazy" src='images/project images/AR/AR-B01.png' className='large__image' alt=""></img>
        <h3>UX/UI references</h3>
        <img loading="lazy" src='images/project images/AR/AR-B02.png' className='large__image' alt=""></img>
      </div>
      ...
      <div id="section3">
        ...
        <img loading="lazy" src='images/project images/AR/AR-C01.png' className='large__image' alt=""></img>
        <h3>Lo-fi wireframes</h3>
        <img loading="lazy" src='images/project images/AR/AR-C02.png' className='large__image' alt=""></img>
        <h4>Concept 1: The audience panel is located on the right side</h4>
        <img loading="lazy" src='images/project images/AR/AR-C03.png' className='large__image' alt=""></img>
        <h4>Concept 2: The audience panel is located in the middle</h4>
        <img loading="lazy" src='images/project images/AR/AR-C04.png' className='large__image' alt=""></img>
        <h3>Hi-fi wireframes</h3>
        <h4>Concept 1: The audience panel is located on the right side</h4>
        <img loading="lazy" src='images/project images/AR/AR-C05.png' className='large__image' alt=""></img>
        <h4>Concept 2: The audience panel is located in the middle</h4>
        <img loading="lazy" src='images/project images/AR/AR-C06.png' className='large__image' alt=""></img>
      </div>
      ...
      <div id="section4">
        ...
        <img loading="lazy" src='images/project images/AR/AR-D00.png' className='large__image' alt=""></img>
        ...
        <img loading="lazy" src='images/project images/AR/AR-D01.png' className='large__image' alt=""></img>
        <h4>Discover new AI-powered audience insights at the campaign level</h4>
        <img loading="lazy" src='images/project images/AR/AR-D02.png' className='large__image' alt=""></img>
        ...
        <img loading="lazy" src='images/project images/AR/AR-D04.png' className='large__image' alt=""></img>
        <h4>See how AI-powered recommended audiences impact campaign performance</h4>
        <img loading="lazy" src='images/project images/AR/AR-D03.png' className='large__image' alt=""></img>
      </div>
      ...
      <div id="section5">
        ...
        <img loading="lazy" src='images/project images/AR/AR-E01.png' className='large__image' alt=""></img>
        <h3>Discover new AI-powered audience insights in the canvas</h3>
        <img loading="lazy" src='images/project images/AR/AR-E02.png' className='large__image' alt=""></img>
        <h3>Discover new AI-powered audience insights at the campaign level</h3>
        <img loading="lazy" src='images/project images/AR/AR-E03.png' className='large__image' alt=""></img>
        <h3>See how AI-powered recommended audiences impact campaign performance</h3>
        <img loading="lazy" src='images/project images/AR/AR-E04.png' className='large__image' alt=""></img>
