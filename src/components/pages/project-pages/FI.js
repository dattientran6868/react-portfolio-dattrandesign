...
function FI() {
    ...
    return (
        <div className="project__container white__container FI" >
            <div>
                <img src='images/project images/FI/FI-0.png'  alt=""></img>
            </div>
            {/* <div>
            ...
            <div id="section2">
                ...
                <img src='images/project images/FI/FI-A1.png' className='extra__small__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-A2.png' className='large__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-A3.png' className='large__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-A4.png' className='large__image' alt=""></img>
            ...
            <div id="section3">
                ...
                <img src='images/project images/FI/FI-B1.png' className='large__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-B2.png' className='large__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-B3.png' className='large__image' alt=""></img>
                <h4>Direction 2: Keep the toolbox element enabled at all times</h4>
                <img src='images/project images/FI/FI-B32.png' className='large__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-B4.png' className='large__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-B5.png' className='medium__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-B6.png' className='medium__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-B7.png' className='medium__image' alt=""></img> */}
                ...
                <img src='images/project images/FI/FI-B8.png' className='large__image' alt=""></img> */}
                ...
                <img src='images/project images/FI/FI-B5.png' className='large__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-B10.png' className='large__image' alt=""></img>
                <h4>Direction 4: Columns</h4>
                <p>This solution visually represents campaign levels using columns.</p >
                <img src='images/project images/FI/FI-B11.png' className='large__image' alt=""></img> */}
                ...
                <img src='images/project images/FI/FI-B6.png' className='large__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-B7.png' className='large__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-B15.png' className='medium__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-B16.png' className='medium__image' alt=""></img> */}
            </div>
            ...
            <div id="section4">
                ...
                <img src='images/project images/FI/FI-C11.png' className='large__image' alt=""></img>
                <h3>Canvas element</h3>
                ...
                <img src='images/project images/FI/FI-C12.png' className='large__image' alt=""></img>
                <p>I selected option 3 and created high-fidelity elements—one for a single ad set and another for multiple ad sets.</p>
                <img src='images/project images/FI/FI-C13.png' className='large__image' alt=""></img>
                <h3>Right drawer</h3>
                ...
                <img src='images/project images/FI/FI-C14.png' className='large__image' alt=""></img>
                <h4>Direction 2: Columns</h4>
                <p>This solution visually represented campaign levels using columns.</p>
                <img src='images/project images/FI/FI-C15.png' className='large__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-C16.png' className='large__image' alt=""></img>
                <p>I then created a high-fidelity design flow that combined the new canvas element with the redesigned drawer..</p>
                <img src='images/project images/FI/FI-C17.png' className='large__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-C21.png' className='large__image' alt=""></img>
                <h3>Authorization process from Canvas</h3>
                ...
                <img src='images/project images/FI/FI-C22.png' className='large__image' alt=""></img>
                <h3>Canvas element</h3>
                ...
                <img src='images/project images/FI/FI-C23.png' className='large__image' alt=""></img>
                ...
                <img src='images/project images/FI/FI-C24.png' className='large__image' alt=""></img>
                <h3>Right drawer</h3>
                ...
                <img src='images/project images/FI/FI-C25.png' className='large__image' alt=""></img>
                <p>Some insights and feedback I gathered after the 2nd iteration:</p>
                <div className='list'>
                    <ul>
            ...
            <div id="section5">
                ...
                {/* <img src='images/project images/FI/FI-D1.png' className='small__image' alt=""></img> */}
                {/* <img src='images/project images/FI/FI-D9.png' className='large__image' alt=""></img> */}
                <h3>Authorize (Connect illumin to Facebook) in licensee settings</h3>
                <img src='images/project images/FI/FI-D2.png' className='large__image' alt=""></img>
                <h3>Authorize (Connect illumin to Facebook) in journey settings</h3>
                <img src='images/project images/FI/FI-D3.png' className='large__image' alt=""></img>
                <h3>Configure Facebook & Instagram ads</h3>
                <img src='images/project images/FI/FI-D4.png' className='large__image' alt=""></img>
            </div>
