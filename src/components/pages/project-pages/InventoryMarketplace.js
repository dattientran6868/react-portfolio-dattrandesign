...
function InventoryMarketplace() {
  ...
  return (
    <div className="project__container inventory__marketplace" >
      <div>
        <img src='images/project images/IM/IM-00.png' className='large__image' alt=""></img>
      </div>
      ...
      <div id="section1">
        ...
        <img loading="lazy" src='images/project images/IM/IM-A02.png' className='large__image' alt=""></img>
      ...
      <div id="section2">
        ...
        <img loading="lazy" src='images/project images/IM/IM-B01.png' className='large__image' alt=""></img>
        <img loading="lazy" src='images/project images/IM/IM-B02.png' className='large__image' alt=""></img>
        ...
        <img loading="lazy" src='images/project images/IM/IM-B03.png' className='large__image' alt=""></img>
      </div>
      ...
      <div id="section3">
        ...
        <img loading="lazy" src='images/project images/IM/IM-C01.png' className='large__image' alt=""></img>
        <h3>Sketching idea</h3>
        <h4>Concept 1: No navigation bar</h4>
        <img loading="lazy" src='images/project images/IM/IM-C02.png' className='large__image' alt=""></img>
        <h4>Concept 2: Left-side navigation bar</h4>
        <img loading="lazy" src='images/project images/IM/IM-C03.png' className='large__image' alt=""></img>
        <h3>Lo-fi wireframes</h3>
        <h4>Concept 1: No navigation bar</h4>
        <img loading="lazy" src='images/project images/IM/IM-C04.png' className='large__image' alt=""></img>
        <h4>Concept 2: Left-side navigation bar</h4>
        <img loading="lazy" src='images/project images/IM/IM-C05.png' className='large__image' alt=""></img>
        <h3>Hi-fi wireframes</h3>
        <h4>Concept 1: No navigation bar</h4>
        <img loading="lazy" src='images/project images/IM/IM-C06.png' className='large__image' alt=""></img>
        <h4>Concept 2: Left-side navigation bar</h4>
        <img loading="lazy" src='images/project images/IM/IM-C07.png' className='large__image' alt=""></img>
      </div>
      ...
      <div id="section4">
        ...
        <img loading="lazy" src='images/project images/IM/IM-D00.png' className='medium__image' alt=""></img>
        ...
        <img loading="lazy" src='images/project images/IM/IM-D01.png' className='large__image' alt=""></img>
        <p>I made UI updates based on feedback from the product team and other stakeholders.</p>
        <img loading="lazy" src='images/project images/IM/IM-D02.png' className='large__image' alt=""></img>
        <p>I also updated the empty state of the right column to make it more user-friendly and visually appealing.</p>
        <img loading="lazy" src='images/project images/IM/IM-D03.png' className='large__image' alt=""></img>
        ...
        <img loading="lazy" src='images/project images/IM/IM-D04.png' className='large__image' alt=""></img>
        <p>The publisher's logo was important for building user trust, so I added it to the deal detail drawer.</p>
        <img loading="lazy" src='images/project images/IM/IM-D05.png' className='large__image' alt=""></img>
        <h3>Action drawer</h3>
        ...
        <img loading="lazy" src='images/project images/IM/IM-Action-flow.png' className='large__image' alt=""></img>
        ...
        <img loading="lazy" src='images/project images/IM/IM-D06.png' className='large__image' alt=""></img>
        <h4>Add deals to a journey</h4>
        <p>Users could add deals to a new or existing journey to run their advertising campaign.</p>
        <img loading="lazy" src='images/project images/IM/IM-D07.png' className='large__image' alt=""></img>
        <img loading="lazy" src='images/project images/IM/IM-D08.png' className='large__image' alt=""></img>
        ...
        <img loading="lazy" src='images/project images/IM/IM-D09.png' className='large__image' alt=""></img>
        <p>I added an animation to the deal detail drawer so that the publisher's logo and deal name always stayed visible.</p>
        <img loading="lazy" src='images/project images/IM/IM-D10.png' className='large__image' alt=""></img>
        <p>I explored different types of graphs to present cost guidance in a clear and useful way.</p>
        <img loading="lazy" src='images/project images/IM/IM-D11.png' className='large__image' alt=""></img>
        ...
        <img loading="lazy" src='images/project images/IM/IM-D12.png' className='large__image' alt=""></img>
        <h4>AI-powered cost guidance with custom CPM</h4>
        <img loading="lazy" src='images/project images/IM/IM-D13.png' className='large__image' alt=""></img>
      </div>
      ...
      <div id="section5">
        ...
        <img loading="lazy" src='images/project images/IM/IM-E01.png' className='large__image' alt=""></img>
        <h3>Inventory marketplace in the Campaign setup drawer</h3>
        <img loading="lazy" src='images/project images/IM/IM-E02.png' className='large__image' alt=""></img>
