...
function FootfallMeasurement() {
    ...
    return (
        <div className="project-page__container project-page footfall__measurement" >
            ...
            <div id='section2'>
                ...
                <img loading="lazy" src='images/project-images/FM/FM-B01.png' className='lg__image'></img>
                <p>Users could select multiple locations and define a radius around each location to measure the impact of their ads.</p>
                <img loading="lazy" src='images/project-images/FM/FM-B02.png' className='lg__image'></img>
            </div>
            ...
            <div id='section3'>
                ...
                <img loading="lazy" src='images/project-images/FM/FM-C01.png' className='lg__image'></img>
                <h4>Lo-fi wireframes</h4>
                {/* <p>I created low-fidelity wireframes to outline the basic design of this feature.</p> */}
                <img loading="lazy" src='images/project-images/FM/FM-C02.png' className='lg__image'></img>
                <h4>Hi-fi wireframes</h4>
                {/* <p>After that, I created high-fidelity wireframes to refine the feature's design.</p> */}
                <img loading="lazy" src='images/project-images/FM/FM-C03.png' className='lg__image'></img>
            </div>
            ...
            <div id='section4'>
                ...
                <img loading="lazy" src='images/project-images/FM/FM-D00.png' className='lg__image'></img>
                ...
                <img loading="lazy" src='images/project-images/FM/FM-D01.png' className='lg__image'></img>
                ...
                <img loading="lazy" src='images/project-images/FM/FM-D02.png' className='lg__image'></img>
                <h4>Hi-fi wireframes of the main flow: Users enabled and set up Footfall Measurement</h4>
                <img loading="lazy" src='images/project-images/FM/FM-D03.png' className='lg__image'></img>
                <h4>Edge case: Users were notified if they hadn't completed the setup</h4>
                <img loading="lazy" src='images/project-images/FM/FM-D04.png' className='lg__image'></img>
                ...
                <img loading="lazy" src='images/project-images/FM/FM-D05.png' className='lg__image'></img>
                <h4>Users could edit or delete locations during the location upload process</h4>
                <img loading="lazy" src='images/project-images/FM/FM-D07.png' className='lg__image'></img>
                <h4>When users uploaded invalid locations, they could edit them and search for valid addresses</h4>
                <img loading="lazy" src='images/project-images/FM/FM-D08.png' className='lg__image'></img>
                <h4>Users could edit or delete multiple locations at once</h4>
                <img loading="lazy" src='images/project-images/FM/FM-D09.png' className='lg__image'></img>
                ...
                <img loading="lazy" src='images/project-images/FM/FM-D06.png' className='lg__image'></img>
                ...
                <img loading="lazy" src='images/project-images/FM/FM-D10.png' className='lg__image'></img>
                ...
                <img loading="lazy" src='images/project-images/FM/FM-D11.png' className='lg__image'></img>
                ...
                <img loading="lazy" src='images/project-images/FM/FM-D12.png' className='lg__image'></img>
                <h4>Users could delete any unused locations</h4>
                <img loading="lazy" src='images/project-images/FM/FM-D13.png' className='lg__image'></img>
            </div>
            ...
            <div id='section5'>
                ...
                <div>
                    ...
                    <img loading="lazy" src='images/project-images/FM/FM-E01.png' className='lg__image'></img>
                    <h4>Users could intuitively edit a location with the map or form fields</h4>
                    <img loading="lazy" src='images/project-images/FM/FM-E02.png' className='lg__image'></img>
                    <h4>Users could delete any unused locations</h4>
                    <img loading="lazy" src='images/project-images/FM/FM-E03.png' className='lg__image'></img>
                    <h4>Users could edit or delete multiple locations at once</h4>
                    <img loading="lazy" src='images/project-images/FM/FM-E04.png' className='lg__image'></img>
                    <h4>Edge case: Users were notified if they hadn't completed the setup</h4>
                    <img loading="lazy" src='images/project-images/FM/FM-E05.png' className='lg__image'></img>
