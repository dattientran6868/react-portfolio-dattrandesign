    ...
    return (
        <div className="project__container support__center" >
            <div className='large__image'>
                <img src='images/project images/SC/SC-0.png' alt=""></img>
            </div>
            <div id='section1'>
                ...
                <img loading="lazy" src='images/project images/SC/SC-A1.png' className='large__image' alt=""></img>
            ...
            <div id='section2'>
                ...
                <img loading="lazy" src='images/project images/SC/SC-B1.png' className='large__image' alt=""></img>
            ...
            <div id='section3'>
                ...
                <h3>Sitemap</h3>
                <img loading="lazy" src='images/project images/SC/SC-C1.png' className='large__image' alt=""></img>
                <h3>Grid system</h3>
                <p>To ensure a seamless experience across different devices, I designed for 4 different screen sizes.</p>
                <img loading="lazy" src='images/project images/SC/SC-C1B.png' className='large__image' alt=""></img>
                ...
                <img loading="lazy" src='images/project images/SC/SC-C02.png' className='large__image' alt=""></img>
                <p>Users could search for any issues, with keywords highlighted in each search result for easier identification.</p>
                <img loading="lazy" src='images/project images/SC/SC-C04.png' className='large__image' alt=""></img>
                <p>Users could easily navigate to all sections and search for articles using the navigation bar.</p>
                <img loading="lazy" src='images/project images/SC/SC-C03.png' className='small__image' alt=""></img>
                ...
                <img loading="lazy" src='images/project images/SC/SC-C05.png' className='large__image' alt=""></img>
                ...
                <img loading="lazy" src='images/project images/SC/SC-C06.png' className='large__image' alt=""></img>
                <p>Users could view the details and track the progress of the cases they had submitted.</p>
                <img loading="lazy" src='images/project images/SC/SC-C07.png' className='large__image' alt=""></img>
            </div>
            ...
            <div id='section4'>
                ...
                <img loading="lazy" src='images/project images/SC/SC-D01.png' className='large__image' alt=""></img>
                ...
                <img loading="lazy" src='images/project images/SC/SC-D02.png' className='large__image' alt=""></img>
                ...
                <img loading="lazy" src='images/project images/SC/SC-D03.png' className='large__image' alt=""></img>
                ...
                <img loading="lazy" src='images/project images/SC/SC-D04.png' className='large__image' alt=""></img>
            </div>
            ...
            <div id='section5'>
                ...
                <h3>Flow 1: Searching for and reading a tutorial</h3>
                <img loading="lazy" src='images/project images/SC/SC-F01.png' className='large__image' alt=""></img>
                <p>Users could search for any issues, with keywords highlighted in each search result for easier identification.</p>
                <img loading="lazy" src='images/project images/SC/SC-F02.png' className='large__image' alt=""></img>
                <p>Users could easily navigate to all sections and search for articles using the navigation bar.</p>
                <img loading="lazy" src='images/project images/SC/SC-F03.png' className='small__image' alt=""></img>
                <h3>Flow 2: Searching for and reading an announcement or product update</h3>
                <img loading="lazy" src='images/project images/SC/SC-F04.png' className='large__image' alt=""></img>
                <h3>Flow 3: Opening and following up on a support case</h3>
                <img loading="lazy" src='images/project images/SC/SC-F05.png' className='large__image' alt=""></img>
                <p>Users could view the details and track the progress of the cases they had submitted.</p>
                <img loading="lazy" src='images/project images/SC/SC-F06.png' className='large__image' alt=""></img>
                <h3>Responsive design of all pages</h3>
                <h3>Home page</h3>
                <img loading="lazy" src='images/project images/SC/SC-E01.png' className='large__image' alt=""></img>
                <h3>Navigation</h3>
                <img loading="lazy" src='images/project images/SC/SC-E02.png' className='large__image' alt=""></img>
                <h3>Topic page</h3>
                <img loading="lazy" src='images/project images/SC/SC-E03.png' className='large__image' alt=""></img>
                <h3>Article page</h3>
                <img loading="lazy" src='images/project images/SC/SC-E04.png' className='large__image' alt=""></img>
                <h3>Search result page</h3>
                <img loading="lazy" src='images/project images/SC/SC-E05.png' className='large__image' alt=""></img>
                <h3>Announcements page</h3>
                <img loading="lazy" src='images/project images/SC/SC-E06.png' className='large__image' alt=""></img>
                <h3>Monthly product updates page</h3>
                <img loading="lazy" src='images/project images/SC/SC-E07.png' className='large__image' alt=""></img>
                <h3>Support page</h3>
                <img loading="lazy" src='images/project images/SC/SC-E08.png' className='large__image' alt=""></img>
                <h3>Choose the type of support page</h3>
                <img loading="lazy" src='images/project images/SC/SC-E09.png' className='large__image' alt=""></img>
                <h3>Open a support case page</h3>
                <img loading="lazy" src='images/project images/SC/SC-E10.png' className='large__image' alt=""></img>
                <h3>Case detail page</h3>
                <img loading="lazy" src='images/project images/SC/SC-E11.png' className='large__image' alt=""></img>
            </div>
